...
for _ in range(num_instances):
    ...
    _, _, greedy_value = greedy_double_knapsack(capacity1, capacity2, weights, values)
    _, _, dp_value = dynamic_programming_double_knapsack(capacity1, capacity2, weights, values)

    relative_distance = abs(greedy_value - dp_value) / dp_value
    greedy_distances.append(relative_distance)

# Plot histogram
plt.hist(greedy_distances, bins=10, edgecolor='black')
